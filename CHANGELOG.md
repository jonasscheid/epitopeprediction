...
- [#341](https://github.com/nf-core/epitopeprediction/pull/341) Stopped re-prepending the sample id at every stage of the prediction filename and shortened the chunk tokens (`_chunk_0` -> `_c0`, allele chunk `chunk3` -> `a3`), so names stay well below the 255-byte filename limit that NetMHCpan/NetMHCIIpan reject ([@jonasscheid](https://github.com/jonasscheid/))
