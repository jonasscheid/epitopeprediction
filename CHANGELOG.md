...
- [#341](https://github.com/nf-core/epitopeprediction/pull/341) Added pan-species prediction via a `<species>-all` sentinel (e.g. `HLA-all`), automatic allele chunking for tools with a per-call allele cap, and a fix for the NetMHCpan/NetMHCIIpan buffer overflow on long work directory paths. Closes [#340](https://github.com/nf-core/epitopeprediction/issues/340) ([@jonasscheid](https://github.com/jonasscheid/))
