...
class RowChecker:
    ...
    # TODO: Add proper validation for HLA nomenclature. Or do we want to give this task to a module?(mhcgnomes/mhcnames)
...
def check_samplesheet(file_in, file_out):
    ...
    with open(file_in, newline="", ) as samplesheet:
        reader = csv.reader(samplesheet, dialect='excel-tab')
